...
- **Реакция на маты**: Использование мата сильно снижает спокойствие и повышает нервозность
- **Система блокировки**: При крайних эмоциях (симпатия < 1, нервозность > 99, спокойствие < 1):
  - Первый раз → грубый ответ с матом, статус меняется на "не в сети"
  - Второй раз → полная блокировка без ответов
- **Восстановление после извинений**: Слова извинения быстро восстанавливают эмоции и отношения
- **Разблокировка**: При восстановлении параметров (симпатия > 10, нервозность < 90, спокойствие > 10) статус возвращается на "онлайн"
